...
const requestTypes = [
  { id: 'LEAVE', label: 'Leave Request', icon: 'calendar-outline' },
  { id: 'EARLY_EXIT', label: 'Early Exit', icon: 'time-outline' },
  { id: 'MISC', label: 'Work From Home / Other', icon: 'home-outline' },
] as const;
...
const NewRequestScreen = () => {
  ...
  const [selectedType, setSelectedType] = useState<'LEAVE' | 'EARLY_EXIT' | 'MISC'>('LEAVE');
...
const styles = StyleSheet.create({
  ...
  contentPadding: { paddingHorizontal: 16, paddingTop: 18, paddingBottom: 110, flexGrow: 1 },
