...
const LoginScreen = () => {
  ...
  const onLogin = async () => {
    if (!credential.trim()) {
      setErrorMessage('Please enter your PIN or registered email address.');
      return;
    }
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        <View style={[styles.card, { backgroundColor: `${colors.surface}EE`, borderColor: colors.outlineVariant }]}>
          ...
          <View style={styles.fieldWrap}>
            <Text style={[styles.label, { color: colors.onSurfaceVariant }]}>Email or PIN</Text>
            <View style={[styles.inputRow, { backgroundColor: colors.surface, borderColor: colors.outlineVariant }]}>
              ...
              <TextInput
                ...
                placeholder="e.g. alex@company.com or 1234"
