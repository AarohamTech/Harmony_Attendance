      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={[styles.contentPadding, { paddingBottom: getBottomTabBarHeight(insets.bottom) }]}>
        <View style={styles.maxWidth}>
          <View style={[styles.profileHero, { backgroundColor: colors.surface, borderColor: colors.outlineVariant }]}>
            ...
            <Text style={[styles.nameText, { color: colors.onSurface }]}>{profile?.name ?? 'Loading...'}</Text>
            <Text style={[styles.idText, { color: colors.onSurfaceVariant }]}>ID: {profile?.employeeId ?? '--'}</Text>
            ...
            <View style={[styles.detailCard, { backgroundColor: colors.surface, borderColor: colors.outlineVariant }]}>
              <View style={styles.detailRow}>
                <View>
                  ...
                  <Text style={[styles.detailValue, { color: colors.onSurface }]}>{profile?.phone ?? 'N/A'}</Text>
                </View>
              ...
              <View style={styles.detailRow}>
                <View>
                  ...
                  <Text style={[styles.detailValue, { color: colors.onSurface }]}>{profile?.email ?? 'N/A'}</Text>
                </View>
          ...
          <View style={styles.sectionBlock}>
            ...
            <View style={styles.twoColumnGrid}>
              <View style={[styles.statCard, { backgroundColor: colors.surface, borderColor: colors.outlineVariant }]}>
                ...
                <Text style={[styles.detailValue, { color: colors.onSurface }]}>{profile?.department ?? 'N/A'}</Text>
              </View>
              <View style={[styles.statCard, { backgroundColor: colors.surface, borderColor: colors.outlineVariant }]}>
                <Text style={[styles.detailLabel, { color: colors.onSurfaceVariant }]}>Designation</Text>
                <Text style={[styles.detailValue, { color: colors.onSurface }]}>{profile?.role ?? 'N/A'}</Text>
              </View>
            </View>
          </View>
            ...
            <View style={[styles.detailCard, { backgroundColor: colors.surface, borderColor: colors.outlineVariant }]}>
              <View style={styles.detailRow}>
                ...
                <View>
                  ...
                  <Text style={[styles.detailValue, { color: colors.onSurface }]}>{profile?.locationLabel ?? 'Padalkar Colony'}</Text>
                </View>
              </View>
              <View style={styles.detailRow}>
                <View style={[styles.locationIcon, { backgroundColor: colors.surfaceContainer }]}>
                ...
                <View>
                  <Text style={[styles.detailLabel, { color: colors.onSurfaceVariant }]}>Shift & Off</Text>
                  <Text style={[styles.detailValue, { color: colors.onSurface }]}>
                    {profile?.shift_start || '09:00'} - {profile?.shift_end || '18:00'}
                  </Text>
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  contentPadding: { paddingTop: 16, flexGrow: 1 },
