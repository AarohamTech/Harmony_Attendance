...
Double-click `run_backend.bat` inside `F:\attendance-service` or `F:\Attendence\frontend`.
...
Double-click `run_frontend.bat` inside `F:\Attendence\frontend` or `F:\attendance-service`.

Or run via command prompt / terminal:
```cmd
cd /d F:\Attendence\frontend
...
### Frontend (`F:\Attendence\frontend`)
