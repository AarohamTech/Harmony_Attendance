...
import { Image, Pressable, ScrollView, StyleSheet, Text, TextInput, View, ActivityIndicator, KeyboardAvoidingView, Platform } from 'react-native';
...
const styles = StyleSheet.create({
  screen: { flex: 1, height: '100%', minHeight: 0, position: 'relative', overflow: 'hidden' },
  scrollView: { flex: 1, minHeight: 0, width: '100%' },
  scrollContent: { flexGrow: 1, justifyContent: 'center', alignItems: 'center', padding: 16, paddingVertical: 32 },
  cardWrapper: { width: '100%', maxWidth: 420, alignItems: 'center' },
  bgOrbOne: { position: 'absolute', top: -40, left: -40, width: 200, height: 200, borderRadius: 100, backgroundColor: '#dbe1ff', opacity: 0.4 },
  bgOrbTwo: { position: 'absolute', right: -60, bottom: -60, width: 240, height: 240, borderRadius: 120, backgroundColor: '#d0e1fb', opacity: 0.4 },
  card: { width: '100%', borderWidth: 1, borderRadius: 24, padding: 24, alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 18, elevation: 4 },
